...
- [RegisterPayload](interfaces/RegisterPayload.md)
- [VerifyOtpParams](interfaces/VerifyOtpParams.md)
- [ChangePasswordParams](interfaces/ChangePasswordParams.md)
- [ResetPasswordParams](interfaces/ResetPasswordParams.md)
- [AuthModule](interfaces/AuthModule.md)
